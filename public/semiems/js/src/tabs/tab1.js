...
function puertas_impares_bat(){
    ...
    if (document.frm.npuertas.value%2!=0 && document.frm.puerta.value == 1){
		...
		parent.innerHTML="Posicion puerta impar:<select name='donde_imp' data-intro ='Si apareciera este campo utilicelo para seleccionar donde quiere la puerta impar.' data-position='bottom'></select>";  // <div>texto<button onclick=\"adddiv('d_" + a + "')\">Agregar division</button><div id='d_" + a + "'></div></div>
		var ind=0;
